-- Fix RLS policies for user_roles table to allow proper admin operations
...
COMMENT ON TABLE public.user_roles IS 'Stores user roles. Users can view their own role. Only admins can modify roles.';
