              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
                {features.map((feature, index) => (
                  ...
                  >
                    ...
                    <h3 className="text-xl font-bold text-foreground mb-4 nerko-one-regular">
                      {feature.title}
                    </h3>
                  ...
                  <div className="space-y-6">
                    ...
                    <div className="flex items-center gap-4 pt-4">
                      <div className="flex items-center gap-2">
                        ...
                        <span className="text-foreground font-medium">Guardian King</span>
                      </div>
                      <div className="flex items-center gap-2">
                        <Star className="w-5 h-5 text-purple-400" />
                        <span className="text-foreground font-medium">Banner of Memory</span>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="relative">
                    <div className="glass-card rounded-2xl p-8 space-y-6">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <h5 className="text-foreground font-semibold nerko-one-regular">Storytelling Companion</h5>
                          <p className="text-muted-foreground text-sm">Guides creators through their narrative journey</p>
                        </div>
                      </div>
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <h5 className="text-foreground font-semibold nerko-one-regular">Community Ambassador</h5>
                          <p className="text-muted-foreground text-sm">Represents platform values and fosters belonging</p>
                        </div>
                      </div>
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <h5 className="text-foreground font-semibold nerko-one-regular">Progress Celebrator</h5>
                          <p className="text-muted-foreground text-sm">Acknowledges user achievements and milestones</p>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div className="max-w-7xl mx-auto">
              ...
              <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                <div className="glass-card rounded-2xl p-8">
                  <h3 className="text-2xl font-bold text-foreground mb-6 mt-4 flex items-center gap-3 nerko-one-regular">
          ...
          >
            <div className="max-w-7xl mx-auto">
              <div className="glass-card rounded-3xl p-12 md:p-16">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
                  <div className="space-y-6">
                    <h3 className="text-2xl font-bold text-foreground mb-6 mt-4 nerko-one-regular">Physical Description</h3>
                    ...
                    <div className="space-y-4">
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          <h4 className="text-foreground font-semibold mb-1 nerko-one-regular">Bright Blue Eyes</h4>
                          <p className="text-muted-foreground text-sm">Captivating blue eyes that are a striking contrast to the white and grey fur</p>
                        </div>
                      </div>
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          <h4 className="text-foreground font-semibold mb-1 nerko-one-regular">Ushanka Hat</h4>
                          <p className="text-muted-foreground text-sm">A large, black fur cap with earflaps that is a defining characteristic of his rugged look</p>
                        </div>
                      </div>
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          <h4 className="text-foreground font-semibold mb-1 nerko-one-regular">Bomber Jacket</h4>
                          <p className="text-muted-foreground text-sm">A black bomber jacket with fur-lined collar, visible pockets, and zipper for a rugged appearance</p>
                        </div>
                      </div>
                      <div className="flex items-start gap-4">
                        ...
                        <div>
                          <h4 className="text-foreground font-semibold mb-1 nerko-one-regular">Pink Nose</h4>
                          <p className="text-muted-foreground text-sm">A charming pink nose that adds a touch of playfulness to his confident expression</p>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      <div key={index} className="flex items-start gap-4">
                        ...
                        <div>
                          <h4 className="text-foreground font-semibold mb-1">{item.trait}</h4>
                  ...
                  <div className="space-y-4">
                    {[
                      ...
                      <div key={index} className="flex items-start gap-4">
                        ...
                        <div>
                          <h4 className="text-foreground font-semibold mb-1">{item.func}</h4>
                          <p className="text-muted-foreground text-sm">{item.desc}</p>
                        </div>
                      </div>
                    ))}
            ...
            <div className="max-w-7xl mx-auto">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div className="glass-card rounded-2xl p-8 text-center">
                  ...
                  <h3 className="text-xl font-bold text-foreground mb-2 mt-4 nerko-one-regular">Concept Art</h3>
                  <p className="text-muted-foreground text-sm">Initial character sketches and design exploration</p>
                </div>
                <div className="glass-card rounded-2xl p-8 text-center">
                  ...
                  <h3 className="text-xl font-bold text-foreground mb-2 mt-4 nerko-one-regular">Official Portrait</h3>
                  <p className="text-muted-foreground text-sm">High-resolution character artwork for branding</p>
                </div>
                <div className="glass-card rounded-2xl p-8 text-center">
                  ...
                  <h3 className="text-xl font-bold text-foreground mb-2 mt-4 nerko-one-regular">Action Scenes</h3>
                  <p className="text-muted-foreground text-sm">Moscowvitz in various platform contexts</p>
                </div>
              </div>
